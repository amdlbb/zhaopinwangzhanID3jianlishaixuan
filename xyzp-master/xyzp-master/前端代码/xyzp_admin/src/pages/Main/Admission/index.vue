    ...
    <div class="mainContent">
      ...
      <div class="mainContentTable">
        ...
        <el-table ref="multipleTable" :data="tableData" style="width: 100%"
          ...
          <el-table-column prop="jobName" label="职位" width="250">
          </el-table-column>
          <el-table-column prop="workAddress" label="工作地址" width="250">
          </el-table-column>
          <el-table-column prop="workTime" label="报道时间" width="250">
          </el-table-column>
